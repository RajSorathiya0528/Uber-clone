    ...
    return (
        <div>
            ...
            <div onClick={()=>{
                ...
                <h3 className='text-2xl font-semibold'>₹{Math.round(props.fare.car)}</h3>
            </div>
            <div onClick={()=>{
                props.setConfirmeRide(true);
                props.selectVehicle('motercycle')
            }}className='flex border-2 border-white active:border-black mb-2 rounded-xl items-center w-full p-3 justify-between'>
                ...
                <h3 className='text-2xl font-semibold'>₹{Math.round(props.fare.motercycle)}</h3>
            </div>
            <div onClick={()=>{
                props.setConfirmeRide(true);
                ...
                <h3 className='text-2xl font-semibold'>₹{Math.round(props.fare.auto)}</h3>
            </div>
        </div>
    )
}
